//  <copyright file="WithNolockInterceptor.cs" project="CodeZero.EntityFramework" solution="CodeZero">
...
namespace CodeZero.EntityFramework.Interceptors
{
    public class WithNoLockInterceptor : DbCommandInterceptor, ITransientDependency
    {
        private const string InterceptionContextKey = "CodeZero.EntityFramework.Interceptors.WithNolockInterceptor";
