//  <copyright file="ICodeZeroWebApiClient.cs" project="CodeZero.Web.Api" solution="CodeZero">
...
{
    /// <summary>
    /// Used to make requests to CodeZero based Web APIs.
    /// </summary>
    public interface ICodeZeroWebApiClient
    {
        /// <summary>
