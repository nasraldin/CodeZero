//  <copyright file="CodeZeroResourceOwnerPasswordValidator.cs" project="CodeZero.IdentityCore.IdentityServer4" solution="CodeZero">
...
{
    public class CodeZeroResourceOwnerPasswordValidator<TUser> : ResourceOwnerPasswordValidator<TUser>
        where TUser : CodeZeroUser<TUser>
    {
        ...
        public CodeZeroResourceOwnerPasswordValidator(
        ...
        protected virtual IEnumerable<Claim> GetAdditionalClaimsOrNull(TUser user)
        {
            ...
            return new[] { new Claim(CodeZeroClaimTypes.TenantId, user.TenantId?.ToString()) };
        }
    }
}
