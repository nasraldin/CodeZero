//  <copyright file="ActionDescriptorExtensions.cs" project="CodeZero.AspNetCore" solution="CodeZero">
...
namespace CodeZero.AspNetCore.Mvc.Extensions
{
    public static class ActionDescriptorExtensions
    {
        public static ControllerActionDescriptor AsControllerActionDescriptor(this ActionDescriptor actionDescriptor)
        {
            ...
            {
                throw new CodeZeroException($"{nameof(actionDescriptor)} should be type of {typeof(ControllerActionDescriptor).AssemblyQualifiedName}");
            }
