//  <copyright file="CodeZeroWebViewPageOfTModel.cs" project="CodeZero.Web.Mvc" solution="CodeZero">
...
namespace CodeZero.Web.Mvc.Views
{
    /// <summary>
    /// Base class for all views in CodeZero system.
    /// </summary>
    /// <typeparam name="TModel">Type of the View Model</typeparam>
    public abstract class CodeZeroWebViewPage<TModel> : WebViewPage<TModel>
    {
        /// <summary>
        ...
        {
            SingletonDependency<ICodeZeroAntiForgeryManager>.Instance.SetCookie(Context);
        }
    }
}
