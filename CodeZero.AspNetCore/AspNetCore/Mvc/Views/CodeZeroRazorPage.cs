//  <copyright file="CodeZeroRazorPage.cs" project="CodeZero.AspNetCore" solution="CodeZero">
...
namespace CodeZero.AspNetCore.Mvc.Views
{
    /// <summary>
    /// Base class for all views in CodeZero system.
    /// </summary>
    /// <typeparam name="TModel">Type of the View Model</typeparam>
    public abstract class CodeZeroRazorPage<TModel> : RazorPage<TModel>
    {
        /// <summary>
