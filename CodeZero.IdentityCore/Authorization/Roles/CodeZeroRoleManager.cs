//  <copyright file="CodeZeroRoleManager.cs" project="CodeZero.IdentityCore" solution="CodeZero">
...
{
    public class CodeZeroRoleManager<TRole, TUser> : RoleManager<TRole>, IDomainService
        ...
        where TUser : CodeZeroUser<TUser>
    {
        ...
        protected CodeZeroRoleStore<TRole, TUser> CodeZeroStore { get; }
