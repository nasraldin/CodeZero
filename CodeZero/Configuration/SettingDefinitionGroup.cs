//  <copyright file="SettingDefinitionGroup.cs" project="CodeZero" solution="CodeZero">
...
namespace CodeZero.Configuration
{
    ...
    public class SettingDefinitionGroup
    {
        ...
        public SettingDefinitionGroup AddChild(SettingDefinitionGroup child)
        {
            ...
            {
                throw new CodeZeroException("Setting group " + child.Name + " has already a Parent (" + child.Parent.Name + ").");
            }
