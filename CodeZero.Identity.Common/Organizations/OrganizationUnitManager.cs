//  <copyright file="OrganizationUnitManager.cs" project="CodeZero.Identity.Common" solution="CodeZero">
...
namespace CodeZero.Organizations
{
    ...
    public class OrganizationUnitManager : DomainService
    {
        ...
        public OrganizationUnitManager(IRepository<OrganizationUnit, long> organizationUnitRepository)
        {
            ...
            LocalizationSourceName = CodeZeroConsts.LocalizationSourceName;
        }
