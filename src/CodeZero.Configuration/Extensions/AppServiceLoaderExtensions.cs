...
/// </summary>
public static partial class AppServiceLoaderExtensions
{
    /// <summary>
    ...
    /// </summary>
    public static WebApplicationBuilder AddAppServiceLoader(this WebApplicationBuilder builder)
    {
        Console.WriteLine("[CodeZero] Adds AppServiceLoader...");
