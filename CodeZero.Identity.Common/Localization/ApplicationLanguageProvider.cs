//  <copyright file="ApplicationLanguageProvider.cs" project="CodeZero.Identity.Common" solution="CodeZero">
...
namespace CodeZero.Localization
{
    ...
    public class ApplicationLanguageProvider : ILanguageProvider
    {
        ...
        {
            var languageInfos = AsyncHelper.RunSync(() => _applicationLanguageManager.GetLanguagesAsync(CodeZeroSession.TenantId))
        ...
        private void SetDefaultLanguage(List<LanguageInfo> languageInfos)
        {
            ...
            var defaultLanguage = AsyncHelper.RunSync(() => _applicationLanguageManager.GetDefaultLanguageOrNullAsync(CodeZeroSession.TenantId));
