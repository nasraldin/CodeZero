//  <copyright file="NotificationDefinitionManager.cs" project="CodeZero" solution="CodeZero">
...
namespace CodeZero.Notifications
{
    ...
    internal class NotificationDefinitionManager : INotificationDefinitionManager, ISingletonDependency
    {
        ...
        public void Add(NotificationDefinition notificationDefinition)
        {
            ...
            {
                throw new CodeZeroInitializationException("There is already a notification definition with given name: " + notificationDefinition.Name + ". Notification names must be unique!");
            }
        ...
        public NotificationDefinition Get(string name)
        {
            ...
            if (definition == null)
            {
                throw new CodeZeroException("There is no notification definition with given name: " + name);
            }
