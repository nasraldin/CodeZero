//  <copyright file="PermissionChecker.cs" project="CodeZero.Identity" solution="CodeZero">
...
namespace CodeZero.Authorization
{
        ...
        where TUser : CodeZeroUser<TUser>
    {
        ...
        /// Constructor.
        /// </summary>
        protected PermissionChecker(CodeZeroUserManager<TRole, TUser> userManager)
        {
        ...
        {
            return CodeZeroSession.UserId.HasValue && await _userManager.IsGrantedAsync(CodeZeroSession.UserId.Value, permissionName);
        }
