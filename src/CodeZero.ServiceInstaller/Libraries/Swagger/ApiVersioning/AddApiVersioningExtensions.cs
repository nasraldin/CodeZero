...
public static partial class ServiceCollectionExtensions
{
        ...
        [NotNull] IConfiguration config)
    {
        ...
        var apiVer = config.GetSection(nameof(DefaultApiVersion)).Get<DefaultApiVersion>() ?? new();
        ...
        services.AddApiVersioning(options =>
        {
            ...
            options.ApiVersionReader = new HeaderApiVersionReader(AppConst.HeaderName.ApiVersion);
        });
