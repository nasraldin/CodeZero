//  <copyright file="EventBus.cs" project="CodeZero" solution="CodeZero">
...
using CodeZero.Events.Bus.Factories.Internals;
using CodeZero.Events.Bus.Handlers;
using CodeZero.Events.Bus.Handlers.Internals;
using CodeZero.Extensions;
using CodeZero.Threading;
using CodeZero.Threading.Extensions;
            ...
            foreach (var handlerFactories in GetHandlerFactories(eventType))
            {
                foreach (var handlerFactory in handlerFactories.EventHandlerFactories)
                {
                    ...
                    else
                    {
                        ...
                        exceptions.Add(new CodeZeroException(message));
                    }
                }
            }
