//  <copyright file="CodeZeroLocalizationHeaderRequestCultureProvider.cs" project="CodeZero.AspNetCore" solution="CodeZero">
...
{
    public class CodeZeroLocalizationHeaderRequestCultureProvider : RequestCultureProvider
    {
