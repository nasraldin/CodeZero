//  <copyright file="MethodInvocationValidator.cs" project="CodeZero" solution="CodeZero">
...
namespace CodeZero.Runtime.Validation.Interception
{
    ...
    public class MethodInvocationValidator : ITransientDependency
    {
        ...
        protected virtual void CheckInitialized()
        {
            if (Method == null)
            {
                throw new CodeZeroException("This object has not been initialized. Call Initialize method first.");
            }
        }
        ...
        {
            throw new CodeZeroValidationException(
