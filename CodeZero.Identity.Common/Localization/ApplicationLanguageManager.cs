//  <copyright file="ApplicationLanguageManager.cs" project="CodeZero.Identity.Common" solution="CodeZero">
...
namespace CodeZero.Localization
{
        ...
        ISingletonDependency
    {
        ...
        /// </summary>
        public const string CacheName = "CodeZeroLanguages";
        ...
        public virtual async Task AddAsync(ApplicationLanguage language)
        {
            ...
            {
                throw new CodeZeroException("There is already a language with name = " + language.Name);
            }
        ...
        public virtual async Task RemoveAsync(int? tenantId, string languageName)
        {
            ...
            {
                throw new CodeZeroException("Can not delete a host language from tenant!");
            }
        ...
        public virtual async Task UpdateAsync(int? tenantId, ApplicationLanguage language)
        {
            ...
            {
                throw new CodeZeroException("Can not update a host language from tenant");
            }
        ...
        public void HandleEvent(EntityChangedEventData<ApplicationLanguage> eventData)
        {
            ...
            _cacheManager.GetCache("CodeZeroLocalizationScripts").Clear();
        }
