//  <copyright file="EfRepositoryBaseOfTEntityAndTPrimaryKey.cs" project="CodeZero.EntityFramework" solution="CodeZero">
...
namespace CodeZero.EntityFramework.Repositories
{
    ...
    public class EfRepositoryBase<TDbContext, TEntity, TPrimaryKey> : CodeZeroRepositoryBase<TEntity, TPrimaryKey>, IRepositoryWithDbContext, ISupportsExplicitLoading<TEntity, TPrimaryKey>
        ...
        where TDbContext : DbContext
    {
            ...
            CancellationToken cancellationToken) where TProperty : class
        {
            ...
            if (expression == null)
            {
                throw new CodeZeroException($"Given {nameof(collectionExpression)} is not a {typeof(MemberExpression).FullName}");
            }
