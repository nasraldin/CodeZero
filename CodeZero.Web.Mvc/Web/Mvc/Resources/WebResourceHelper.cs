//  <copyright file="WebResourceHelper.cs" project="CodeZero.Web.Mvc" solution="CodeZero">
...
using CodeZero.Web.Mvc.Resources.Embedded.Handlers;

namespace CodeZero.Web.Mvc.Resources
{
    /// <summary>
    ...
    public static class WebResourceHelper
    {
        ...
        public static void ExposeEmbeddedResources(string rootPath, Assembly assembly, string resourceNamespace)
        {
            ...
            RouteTable.Routes.MapRoute(
                ...
                defaults: new
                {
                    controller = "CodeZeroNoController",
                    action = "CodeZeroNoAction"
                }
