//  <copyright file="CodeZeroUserStore.cs" project="CodeZero.Identity" solution="CodeZero">
...
namespace CodeZero.Authorization.Users
{
    ...
    /// </summary>
    public abstract class CodeZeroUserStore<TRole, TUser> :
        ...
        where TUser : CodeZeroUser<TUser>
    {
        ...
        private async Task<TRole> GetRoleByNameAsync(string roleName)
        {
            ...
            if (role == null)
            {
                throw new CodeZeroException("Could not find a role with name: " + roleName);
            }
