//  <copyright file="CodeZeroPageModel.cs" project="CodeZero.AspNetCore" solution="CodeZero">
...
namespace CodeZero.AspNetCore.Mvc.RazorPages
{
    /// <summary>
    /// Base class for all MVC Controllers in CodeZero system.
    /// </summary>
    public abstract class CodeZeroPageModel : PageModel, ITransientDependency
    {
        /// <summary>
