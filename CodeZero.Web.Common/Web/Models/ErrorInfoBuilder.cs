//  <copyright file="ErrorInfoBuilder.cs" project="CodeZero.Web.Common" solution="CodeZero">
...
namespace CodeZero.Web.Models
{
    ...
    public class ErrorInfoBuilder : IErrorInfoBuilder, ISingletonDependency
    {
        ...
        /// <inheritdoc/>
        public ErrorInfoBuilder(ICodeZeroWebCommonModuleConfiguration configuration, ILocalizationManager localizationManager)
        {
