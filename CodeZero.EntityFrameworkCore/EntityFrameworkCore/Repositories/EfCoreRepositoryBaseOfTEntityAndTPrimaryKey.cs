//  <copyright file="EfCoreRepositoryBaseOfTEntityAndTPrimaryKey.cs" project="CodeZero.EntityFrameworkCore" solution="CodeZero">
...
namespace CodeZero.EntityFrameworkCore.Repositories
{
    ...
    public class EfCoreRepositoryBase<TDbContext, TEntity, TPrimaryKey> : 
        CodeZeroRepositoryBase<TEntity, TPrimaryKey>,
