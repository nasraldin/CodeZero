...
public static class ObjectExtensions
{
    ...
    /// <summary>
    /// Converts given object to a value or enum type using 
    /// <see cref="Convert.ChangeType(object,TypeCode)"/> or 
    ...
    /// <paramref name="func"/> if the <paramref name="condition"/> is <code>true</code>)
    ...
    /// <param name="obj">An object</param>
    /// <param name="condition">A condition</param>
    /// <param name="action">An action that is executed only if 
    ...
    /// <param name="text">The text to be written on 
    /// the ArgumentNullException: [text] not allowed to be null</param>
