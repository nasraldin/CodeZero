//  <copyright file="UnitOfWorkBase.cs" project="CodeZero" solution="CodeZero">
...
namespace CodeZero.Domain.Uow
{
    ...
    public abstract class UnitOfWorkBase : IUnitOfWork
    {
        ...
        /// <summary>
        /// Reference to current CodeZero session.
        /// </summary>
        public ICodeZeroSession CodeZeroSession { protected get; set; }
        ...
        public void Begin(UnitOfWorkOptions options)
        {
            ...
            SetTenantId(CodeZeroSession.TenantId, false);
        ...
        public virtual IDisposable SetTenantId(int? tenantId, bool switchMustHaveTenantEnableDisable)
        {
            ...
            if (switchMustHaveTenantEnableDisable)
            {
                mustHaveTenantEnableChange = tenantId == null
                    ? DisableFilter(CodeZeroDataFilters.MustHaveTenant)
                    : EnableFilter(CodeZeroDataFilters.MustHaveTenant);
            }
            else
            {
            ...
            var mayHaveTenantChange = SetFilterParameter(CodeZeroDataFilters.MayHaveTenant, CodeZeroDataFilters.Parameters.TenantId, tenantId);
            var mustHaveTenantChange = SetFilterParameter(CodeZeroDataFilters.MustHaveTenant, CodeZeroDataFilters.Parameters.TenantId, tenantId ?? 0);
        ...
        private void PreventMultipleBegin()
        {
            ...
            {
                throw new CodeZeroException("This unit of work has started before. Can not call Start method more than once.");
            }
        ...
        private void PreventMultipleComplete()
        {
            ...
            {
                throw new CodeZeroException("Complete is called before!");
            }
        ...
        private void SetFilters(List<DataFilterConfiguration> filterOverrides)
        {
            ...
            if (CodeZeroSession.TenantId == null)
            {
                ChangeFilterIsEnabledIfNotOverrided(filterOverrides, CodeZeroDataFilters.MustHaveTenant, false);
            }
        }
        ...
        private DataFilterConfiguration GetFilter(string filterName)
        {
            ...
            if (filter == null)
            {
                throw new CodeZeroException("Unknown filter name: " + filterName + ". Be sure this filter is registered before.");
            }
