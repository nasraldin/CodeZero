//  <copyright file="CodeZeroEntityMaterializerSource.cs" project="CodeZero.EntityFrameworkCore" solution="CodeZero">
...
namespace CodeZero.EntityFrameworkCore
{
    ...
    public class CodeZeroEntityMaterializerSource : EntityMaterializerSource
    {
        private static readonly MethodInfo NormalizeDateTimeMethod =
            typeof(CodeZeroEntityMaterializerSource).GetTypeInfo().GetMethod(nameof(NormalizeDateTime), BindingFlags.Static | BindingFlags.NonPublic);

        private static readonly MethodInfo NormalizeNullableDateTimeMethod =
            typeof(CodeZeroEntityMaterializerSource).GetTypeInfo().GetMethod(nameof(NormalizeNullableDateTime), BindingFlags.Static | BindingFlags.NonPublic);
