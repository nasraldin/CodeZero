//  <copyright file="ApiControllerBuilder.cs" project="CodeZero.Web.Api" solution="CodeZero">
...
using CodeZero.WebApi.Controllers.Dynamic.Interceptors;
...
namespace CodeZero.WebApi.Controllers.Dynamic.Builders
{
    ...
    internal class ApiControllerBuilder<T> : IApiControllerBuilder<T>
    {
        ...
        public IApiControllerActionBuilder<T> ForMethod(string methodName)
        {
            ...
            {
                throw new CodeZeroException("There is no method with name " + methodName + " in type " + typeof(T).Name);
            }
        ...
        public void Build()
        {
            var controllerInfo = new DynamicApiControllerInfo(
                ...
                typeof(CodeZeroDynamicApiControllerInterceptor<T>),
                Filters,
