//  <copyright file="CodeZeroTimer.cs" project="CodeZero" solution="CodeZero">
...
namespace CodeZero.Threading.Timers
{
    /// <summary>
    ...
    public class CodeZeroTimer : RunnableBase, ITransientDependency
    {
        /// <summary>
        ...
        public CodeZeroTimer(int period, bool runOnStart = false)
            : this()
        {
            Period = period;
        ...
        public override void Start()
        {
            if (Period <= 0)
            {
                throw new CodeZeroException("Period should be set before starting the timer!");
            }
