//  <copyright file="CodeZeroIdentityDbModelBuilderExtensions.cs" project="CodeZero.Identity.EntityFramework" solution="CodeZero">
...
namespace CodeZero.Identity.EntityFramework
{
    ...
    /// </summary>
    public static class CodeZeroIdentityDbModelBuilderExtensions
    {
        /// <summary>
        ...
        public static void ChangeCodeZeroTablePrefix<TTenant, TRole, TUser>(this DbModelBuilder modelBuilder, string prefix, string schemaName = null)
