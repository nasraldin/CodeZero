//  <copyright file="CodeZeroIdentityCommonDbContext.cs" project="CodeZero.IdentityCore.EntityFrameworkCore" solution="CodeZero">
...
{
    public abstract class CodeZeroCommonDbContext<TRole, TUser, TSelf> : CodeZeroDbContext
        where TRole : CodeZeroRole<TUser>
        where TUser : CodeZeroUser<TUser>
        where TSelf : CodeZeroCommonDbContext<TRole, TUser, TSelf>
    {
        /// <summary>
        /// Roles.
        /// </summary>
        ...
        protected CodeZeroCommonDbContext(DbContextOptions<TSelf> options)
            : base(options)
        {
