//  <copyright file="CodeZeroRole.cs" project="CodeZero.IdentityCore" solution="CodeZero">
...
namespace CodeZero.Authorization.Roles
{
    ...
    /// </remarks>
    public abstract class CodeZeroRole<TUser> : CodeZeroRoleBase, IFullAudited<TUser>
