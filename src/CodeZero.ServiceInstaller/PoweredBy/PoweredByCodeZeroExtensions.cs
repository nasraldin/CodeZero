...
public static class PoweredByCodeZeroExtensions
{
    /// <summary>
    /// Configures whether use or not the Header X-Powered-By.
    /// Default value is CodeZero.
    /// </summary>
    ...
    public static IApplicationBuilder UsePoweredByCodeZero(this IApplicationBuilder app, bool enabled)
    {
