//  <copyright file="CodeZeroModule.cs" project="CodeZero" solution="CodeZero">
...
namespace CodeZero.Modules
{
    ...
    /// </remarks>
    public abstract class CodeZeroModule
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets a reference to the CodeZero configuration.
        /// </summary>
        protected internal ICodeZeroStartupConfiguration Configuration { get; internal set; }
        ...
        /// <summary>
        /// Checks if given type is an CodeZero module class.
        /// </summary>
        /// <param name="type">Type to check</param>
        public static bool IsCodeZeroModule(Type type)
        {
            ...
            return
                ...
                typeof(CodeZeroModule).IsAssignableFrom(type);
        }
        ...
        {
            if (!IsCodeZeroModule(moduleType))
            {
        ...
        public static List<Type> FindDependedModuleTypesRecursivelyIncludingGivenModule(Type moduleType)
        {
            ...
            list.AddIfNotContains(typeof(CodeZeroKernelModule));
            return list;
        }

        private static void AddModuleAndDependenciesRecursively(List<Type> modules, Type module)
        {
            if (!IsCodeZeroModule(module))
            {
                throw new CodeZeroInitializationException("This type is not an CodeZero module: " + module.AssemblyQualifiedName);
            }
