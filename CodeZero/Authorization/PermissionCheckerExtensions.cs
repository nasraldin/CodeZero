//  <copyright file="PermissionCheckerExtensions.cs" project="CodeZero" solution="CodeZero">
...
namespace CodeZero.Authorization
{
    ...
    public static class PermissionCheckerExtensions
    {
        ...
        /// throws <see cref="CodeZeroAuthorizationException"/> if not authorized.
        ...
        /// <exception cref="CodeZeroAuthorizationException">Throws authorization exception if</exception>
        ...
        public static string L(IPermissionChecker permissionChecker, string name, string defaultValue)
        {
            ...
            {
                return localizationManager.Object.GetString(CodeZeroConsts.LocalizationSourceName, name);
            }
        }
