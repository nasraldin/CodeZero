//  <copyright file="TypeScriptServiceGenerator.cs" project="CodeZero.Web.Api" solution="CodeZero">
    ...
    public class TypeScriptServiceGenerator : ITransientDependency
    {
        ...
        public string GetScript()
        {
            ...
            if (servicePrefix.IsNullOrEmpty())
                script.AppendLine("module CodeZero.services");//Create a new Module
            else
                script.AppendLine("module CodeZero.services." + servicePrefix);//Create a new Module
            script.AppendLine("{");
            ...
            script.AppendLine("}");
            #region Create Script for CodeZero common objects

            script.AppendLine("declare module CodeZero {");
