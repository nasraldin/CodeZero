//  <copyright file="ICodeZeroFeatureValueStore.cs" project="CodeZero.Identity.Common" solution="CodeZero">
...
{
    public interface ICodeZeroFeatureValueStore : IFeatureValueStore
    {
