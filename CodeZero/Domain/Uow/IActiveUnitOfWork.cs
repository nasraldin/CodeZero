//  <copyright file="IActiveUnitOfWork.cs" project="CodeZero" solution="CodeZero">
...
namespace CodeZero.Domain.Uow
{
    ...
    public interface IActiveUnitOfWork
    {
        ...
        /// </summary>
        /// <param name="filterNames">One or more filter names. <see cref="CodeZeroDataFilters"/> for standard filters.</param>
        ...
        /// </summary>
        /// <param name="filterName">Name of the filter. <see cref="CodeZeroDataFilters"/> for standard filters.</param>
