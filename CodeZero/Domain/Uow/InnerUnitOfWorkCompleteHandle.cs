//  <copyright file="InnerUnitOfWorkCompleteHandle.cs" project="CodeZero" solution="CodeZero">
    ...
    internal class InnerUnitOfWorkCompleteHandle : IUnitOfWorkCompleteHandle
    {
        ...
        public void Dispose()
        {
            ...
            if (!_isCompleteCalled)
            {
                ...
                throw new CodeZeroException(DidNotCallCompleteMethodExceptionMessage);
            }
        }
